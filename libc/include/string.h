...
/* Write the word val (interpreted as unsigned short) to the first n
   words of the memory area pointed to by s.
   Returns dst.
*/
...
/*  Returns a pointer to a null-terminated byte string, which is a duplicate
    of the string pointed to by str1. The returned pointer must be passed
